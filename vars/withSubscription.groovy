...
def identityBasedLogin(String subscription, Closure body) {
  ansiColor('xterm') {
    ...
    withSubscriptionLogin(subscription) {
      ...
      def tfStateStorageAccountNameTemplate = env.TF_STATE_STORAGE_TEMPLATE ?: "statestore"
      def tfStateContainerNameTemplate = env.TF_STATE_CONTAINER_TEMPLATE ?: "statectr"
